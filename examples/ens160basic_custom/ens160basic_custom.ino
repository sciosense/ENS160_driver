...
void setup() {
  ...
  if (ens160.available()) {
    ...
    ens160.initCustomMode(3);                                     // Create custom sequence with three steps
                                                                  // time is a multiple of 24ms, 0 = no measurement, 1 = measurement, temperatures in Celsius
    ens160.addCustomStep(48, 0, 0, 0, 0, 80, 80, 80, 80);         // Step 1: 48ms, no measurments, all hotplates at low temperatures 
    ens160.addCustomStep(360, 1, 1, 1, 1, 160, 215, 215, 200);    // Step 2: 360ms, measurments done, all hotplates at medium temperatures 
